package org.nasdanika.models.travel.doc.tests;
...
public class TestDocSiteGen {
	...
	@Test
	public void testGenerateTravelDocSite() throws Exception {
		CapabilityLoader capabilityLoader = new CapabilityLoader();
		ProgressMonitor progressMonitor = new PrintStreamProgressMonitor();
		
		Requirement<ResourceSetRequirement, ResourceSet> requirement = ServiceCapabilityFactory.createRequirement(ResourceSet.class);		
		ResourceSet resourceSet = capabilityLoader.loadOne(requirement, progressMonitor);
		Resource resource = resourceSet.getResource(URI.createFileURI("test-metadata.xml"), true); // TODO - diagram with semantic mapping
		JourneyLog database = (JourneyLog) resource.getContents().get(0);
		...
		File output = new File(actionModelsDir, "travel-actions.xmi");
		...
		String rootActionResource = "travel-actions.yml";
