package org.nasdanika.models.travel.ecore.tests;
...
import org.nasdanika.models.travel.ecore.EcoreGenTravelProcessorsFactory;
//import org.nasdanika.models.party.PartyPackage;
 ...
 *
 */
public class TestTravellModelDocGen {
	
	@Test
	public void testGenerateTravelModelDoc() throws IOException, DiagnosticException {
		ProgressMonitor progressMonitor = new NullProgressMonitor(); // new PrintStreamProgressMonitor();
		MutableContext context = Context.EMPTY_CONTEXT.fork();
		Consumer<Diagnostic> diagnosticConsumer = d -> d.dump(System.out, 0);
		List<Function<URI,Action>> actionProviders = new ArrayList<>();		
		EcoreGenTravelProcessorsFactory ecoreGenFamilyProcessorFactory = new EcoreGenTravelProcessorsFactory(context);		
		...
		File output = new File(actionModelsDir, "travel.xmi");
		...
		String siteMapDomain = "https://travel.models.nasdanika.org";		
