...
public class ECoreGenTravelProcessorsCapabilityFactory implements CapabilityFactory<TargetRequirement, Object> {
		...
		return CompletableFuture.completedStage(
				Collections.singleton(
						CapabilityProvider.of(
								new EcoreGenTravelProcessorsFactory(requirement.requirement().context()))));
	}
